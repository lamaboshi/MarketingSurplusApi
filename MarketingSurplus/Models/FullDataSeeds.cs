...
modelBuilder.Entity<CompanyProduct>().HasData(new CompanyProduct
{
    ...
    ProductId = 145
            ...
            //PayMethod table
                ...
                //Order table
                modelBuilder.Entity<Order>().HasData(new Order { Id = 1, Name = "Order 1", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 20000, IsDelivery = true,  UserId = 1, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 2, Name = "Order 2", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 15000, IsDelivery = true, UserId = 6, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 3, Name = "Order 3", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 20000, IsDelivery = true,  UserId = 8, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 4, Name = "Order 4", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 200000, IsDelivery = true, UserId = 3, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 5, Name = "Order 5", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 5000, IsDelivery = true,  UserId = 2, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 6, Name = "Order 6", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 30000, IsDelivery = false,  UserId = 5, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 7, Name = "Order 7", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 20000, IsDelivery = false, UserId = 7, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 8, Name = "Order 8", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 70000, IsDelivery = false, UserId = 9, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 9, Name = "Order 9", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 60000, IsDelivery = false,  UserId = 10, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 10, Name = "Order 10", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 20000, IsDelivery = true,  UserId = 8, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 11, Name = "Order 11", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 25000, IsDelivery = true,  UserId = 15, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 12, Name = "Order 12", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 60000, IsDelivery = false, UserId = 14, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 13, Name = "Order 13", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 80000, IsDelivery = true,  UserId = 13, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 14, Name = "Order 14", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 100000, IsDelivery = false,  UserId = 12, });
                modelBuilder.Entity<Order>().HasData(new Order { Id = 15, Name = "Order 15", Descripation = "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", Price = 70000, IsDelivery = true,  UserId = 11, });
                //Subscription table
            ...
            modelBuilder.Entity<Subscription>().HasData(new Subscription { Id = 11, CompanyId = 13, UserId = 14, });
                ...
                modelBuilder.Entity<Evalution>().HasData(new Evalution { Id = 6, SubscriptionId = 6, RateId = 4, });
                ...
                modelBuilder.Entity<Evalution>().HasData(new Evalution { Id = 10, SubscriptionId = 10, RateId = 2, });
                ...
                modelBuilder.Entity<Evalution>().HasData(new Evalution { Id = 14, SubscriptionId = 14, RateId = 3, });
