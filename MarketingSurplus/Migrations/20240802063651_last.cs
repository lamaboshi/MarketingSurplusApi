...
namespace MarketingSurplus.Migrations
{
    ...
    public partial class last : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "OrderTypes",
                columns: new[] { "Id", "Name", "Percentage", "isAccept" },
                values: new object[,]
                {
                    { 1, "Normal", null, false },
                    { 2, "Donation", null, false },
                    { 3, "Charity Organization", null, false }
                });

            migrationBuilder.InsertData(
                table: "PayMethods",
                columns: new[] { "Id", "Name", "isAccept" },
                values: new object[,]
                {
                    { 1, "Cash Pay", false },
                    { 2, "PayPal", false },
            ...
            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "Amount", "CreatedAt", "Descripation", "IsDelivery", "Name", "Price", "UserId" },
                values: new object[,]
                {
                    { 1, 10, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "The order was placed at 3:05 and will expire after a quarter of an hour from this time ", true, "Order 1", 20000f, 1 },
                    { 2, 5, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "The order was placed at 2:50 and will expire after a quarter of an hour from this time", false, "Order 2", 18520f, 2 },
                    { 3, 6, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "The order was placed at 4:40 and will expire after a quarter of an hour from this time", true, "Order 3", 75312f, 3 },
                    { 4, 4, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "The order was placed at 3:20 and will expire after a quarter of an hour from this time", true, "Order 4", 12457f, 3 },
                    { 5, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "The order was placed at 1:15 and will expire after a quarter of an hour from this time", false, "Order 5", 45632f, 2 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Bills",
                columns: new[] { "Id", "CreatedAt", "Note", "OrderProductId", "OrderStatusId" },
                values: new object[,]
                {
                    { 10, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "  Welcom to you", 4, 1 },
                    { 21, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), " Welcom to you", 2, 1 },
                    { 22, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), " Welcom to you", 2, 2 },
                    { 23, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), " Welcom to you", 1, 1 },
                    { 24, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), " Welcom to you", 3, 1 }
                });
